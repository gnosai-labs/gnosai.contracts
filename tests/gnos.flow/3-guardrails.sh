...
expect_fail mpush $pay_token transfer "[\"$owner\",\"$song_reg\",\"10.0000 CISUM\",\"SONGCREATE:2:6000000001:bad-amount-song-hash\"]" -p $owner
expect_fail mpush $pay_token transfer "[\"$owner\",\"$song_reg\",\"1010.0000 CISUM\",\"SONGCREATE:101:6000000001:too-many-song-hash\"]" -p $owner
